...
public abstract class BaseSetting<T> {
    ...
    public static interface ISettingListener<T> {
         ...
         *
         * @param store The name of the preferences store
     ...
     *
     * @param context The {@link android.content.Context} that has {@link android.content.SharedPreferences}
     * @return {@link android.content.SharedPreferences} in mode {@link android.content.Context#MODE_PRIVATE}
     */
     ...
     * Do not {@link android.content.SharedPreferences.Editor#commit()} or {@link android.content.SharedPreferences.Editor#apply()}
     *
     * @param editor The {@link android.content.SharedPreferences.Editor} to save the value to
     ...
     *
     * @param prefs        {@link android.content.SharedPreferences} to pull from
     * @param name         Name of the setting to acquire
     * @param defaultValue The default value to return
     * @return The value from {@link android.content.SharedPreferences} or the default value
     */
