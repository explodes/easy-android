...
public class NotificationCenter {
    ...
    public static class Notification {
         ...
         *
         * @param notificationName Name of the {@link Notification}, subscribers subscribed to the
         *                         notification by this name will be notified
         */
    ...
    public static interface INotificationListener {
         ...
         *
         * @param notificationCenter The {@link NotificationCenter} sending the broadcast
         * @param notification       The actual {@link Notification} being broadcasted
         */
...
// static
    ...
    /**
     * Construct a new {@link NotificationCenter}
     * Consider using {@link NotificationCenter#getDefaultInstance()}
     */
     ...
     *
     * @param notificationName The name of the {@link Notification} to broadcast
     */
     ...
     *
     * @param notification The {@link Notification} / Notification-subclass to broadcast
     */
     ...
     *
     * @param notificationName The name of the {@link Notification} to subscribe to
     ...
     *
     * @param notificationName The name of the {@link Notification} to un-subscribe from
     * @param listener         The subscriber
     */
