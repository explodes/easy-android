...
public class Fonts {
	...
	/**
	 * Apply a {@link android.graphics.Typeface} to a list of
	 * {@link android.view.View} objects specified by ids. <br/>
	 * <br/>
	 ...
	 * @param root
	 *            Root {@link android.view.View} containing the subviews to
	 *            search for
	 * @param viewIds
	 *            Comma separated list of view resIds that are under {@value
	 *            root}
	 */
