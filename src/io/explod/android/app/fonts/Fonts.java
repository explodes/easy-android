...
public class Fonts {
     ...
     *
     * @param context Originating mContext
     * @param path    String path after the {@literal assets} folder.
     ...
     *
     * @param font    The font to apply to the views
     * @param root    Root {@link android.view.View} containing the subviews to search for
     * @param viewIds Comma separated list of view resIds that are under {@value root}
     */
