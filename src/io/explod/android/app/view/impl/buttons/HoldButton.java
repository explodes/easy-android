...
/**
 * Button that fires onHold events periodically. Register your listener with
 * 'setOnHoldListener(OnHoldListener listener)' Update the event rate with
 * 'setFrequency(int millis)'
 * 
 * @author evan
 */
public class HoldButton extends Button {
	...
	/**
	 * Perform the construction of the object, no matter how this object was
	 * instantiated.
	 * 
	 * @param context
	 */
