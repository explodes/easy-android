 ...
 * 
 * @param <ViewType>
 *            The ViewType this ViewAdapter will construct
 * @param <DataType>
 *            The DataType this ViewAdapter will assign to views
 * @author evan
 */
public abstract class ViewAdapter<ViewType extends View, DataType> extends ArrayAdapter<DataType> {
	 ...
	 * An ArrayList of DataType will be created that you can retrieve with
	 * {@link #getData()}
	 * 
	 * @param context
	 *            Context with which ViewTypes will be constructed with
	 */
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			view = this.createView(context, parent, viewType);
		} else {
	 ...
	 * Manipulation of this data will still require a call to
	 * {@link #notifyDataSetChanged()}
	 * 
	 * @return Either the data this object was constructed with, or the
	 *         ArrayList it created as a placeholder.
	 */
	 ...
	 * @param parent
	 *            The parent to which the created view will be assigned
	 * @param viewType
	 *            The view type to create, as specified by with
	 *            {@link #getItemViewType(int)}
	 * @return A new, unpopulated, ViewType
	 * @see android.view.LayoutInflater#inflate(int, android.view.ViewGroup,
	 *      boolean)
	 */
	public abstract ViewType createView(Context context, ViewGroup parent, int viewType);
	 ...
	 * @param data
	 *            Data to populate view with
	 * @param viewType
	 *            The view type to populate, as specified by with
	 *            {@link #getItemViewType(int)}
	 */
