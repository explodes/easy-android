 ...
 *
 * @param <DataType>  Data type contained in this adapter.
 * @param <GroupView> View type for groups.
 * @param <ChildView> View type for children.
 * @author evan
 */
public abstract class NamedListExpandableListAdapter<DataType, GroupView extends View, ChildView extends View> extends BaseExpandableListAdapter {
     ...
     *
     * @param context Context to build a view from
     ...
     *
     * @param view       GroupView to update
     * @param data       NamedList to update the GroupView with
     * @param isExpanded Whether or not the GroupView is expanded
     */
     ...
     *
     * @param view        ChildView to update
     * @param item        Data to update the ChildView with
     * @param isLastChild Whether or not this is the last child in the group
     */
     ...
     *
     * @param data Data list the child belongs under
     * @param item Data the child has
