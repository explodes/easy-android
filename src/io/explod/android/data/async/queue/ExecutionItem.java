...
public abstract class ExecutionItem {
     ...
     *
     * @param tag Information that is desired to be retrieved from this item at a later point.
     */
     ...
     * Perform some task.
     *
     * @param callback Callback must be called when this item has finished. It indications both completion and error status.
     */
