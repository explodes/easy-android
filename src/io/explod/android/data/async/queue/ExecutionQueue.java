 ...
 *
 * @param <ExecutionItemType> Class of the ExecutionItem to use.
 * @author evan
 */
public class ExecutionQueue<ExecutionItemType extends ExecutionItem> {
    ...
    public interface IExecutionQueueListener<ExecutionItemType extends ExecutionItem> {
        /**
         * @param sender   ExecutionQueue that send this event
         * @param item     ExecutionItem that finished
         * @param error    Error produced during item's execution
         * @param lastItem Was this item the last one?
         */
