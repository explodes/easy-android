package io.explod.easyandroid.impl.button;
 ...
 * 
 */
public class PressAndHoldButton extends Button {
	...
	/**
	 * Standard view constructor for {@link PressAndHoldButton}
	 * 
	 * @param context
	 */
	 ...
	 * @param attrs
	 */
	public PressAndHoldButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.start(context);
	}
	 ...
	 * @param defStyle
	 */
	public PressAndHoldButton(Context context, AttributeSet attrs, int defStyle) {
	...
	protected void start(Context context) {
		...
		this.sendEvent = new Runnable() {
			@Override
			public void run() {
				final PressAndHoldButton self = PressAndHoldButton.this;
				if (self.pressed) {
